<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="adminlontro_list" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CFE7F7">
        <tr>
            <td height="30" colspan="7" align="right" bgcolor="#FFFFFF">
                <span class="cs8">
                    <asp:Literal ID="pager" runat="server"></asp:Literal></span>
                &nbsp;
            </td>
        </tr>
        </table>
        ...
        <tr>
            <td align="left" valign="top">
                <table width="18%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="center">
        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="images/a5.jpg" 
